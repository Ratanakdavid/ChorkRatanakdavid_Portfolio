...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="py-16 lg:py-30">
      <div
        className="w-[90%] md:w-[80%] lg:w-[70%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6
        lg:gap-12"
      >
        <div>
          <h2
              ...
              return (
                <Link
                  ...
                  className="group flex 
                            items-center gap-4 px-2 py-3
                            transition-colors hover-bg-white/5
                            rounded-lg"
                >
                  <div
                    className="h-15 w-15 rounded-full bg-white/5
                                text-white transition-transform group-hover:scale-105 grid
                                place-items-center"
                  >
                    {item.icon}
                  </div>
